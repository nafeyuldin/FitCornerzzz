...
import SexIcon from '../../public/Assets/home_gym_bodybuilding/sexIcon.svg';
  ...
  return (
    <div className="profilecard ">
      ...
      <Grid container xs={12} className="flex flex-col gap-y-4">
        ...
        <Box className="flex gap-2 justify-start items-center">
          <Image src={SexIcon} height={20} alt="s" />
          <Typography className="text-[16px]">{props.sex}</Typography>
        </Box>
      </Grid>
            ...
            <Table className="w-full">
              ...
              <TableBody>
                <TableRow>
                  ...
                  <TableCell>45 JOD</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>3 Month</TableCell>
                  <TableCell>90 JOD</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>6 Month</TableCell>
                  <TableCell>150 JOD</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>1 Year</TableCell>
                  <TableCell>250 JOD</TableCell>
                </TableRow>
              </TableBody>
            </Table>
          </TableContainer>
      ...
      <Grid container xs={12}>
        <Box className="w-full flex flex-col items-start justify-center ">
          ...
          <Box className="w-full flex flex-col items-start gap-y-3 justify-center ">
            ...
            <li className="text-[20px]">Consectetur adipiscing elit.</li>
          </Box>
        </Box>
      </Grid>
