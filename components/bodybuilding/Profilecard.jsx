    ...
    <div className="profilecard ">
      <Card>
        <Grid container xs={12} className=" ">
          <Grid
            xs={4}
            className="bg-[#F2F2F2] flex md:items-center md:justify-center"
          >
            <Image src={props.image} alt="marcelo" height={352} width={352} />
          </Grid>
          <Grid xs={8} className="flex flex-col  md:pt-10">
