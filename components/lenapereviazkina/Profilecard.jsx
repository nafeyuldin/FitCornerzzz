...
import Lena1 from '../../public/Assets/home_pts_fitness_lena/1.svg';
  ...
  return (
    <div className="profilecard ">
      <Grid container xs={12} className="flex ">
        <Grid item xs={5} className="bg-[#F2F2F2] ">
          <Image src={props.image} alt="lena" height={352} />
        </Grid>
        <Grid item xs={7} className="flex flex-col  md:pt-8">
          <Grid className="flex flex-col  px-5  w-full">
            ...
            <Box className="  .profiledetail md:flex hidden flex-col gap-y-3">
              ...
              <Box className="flex w-full md:gap-8 mt-[4.5vw] ">
      ...
      <Grid container xs={12}>
        <Box className="w-full flex flex-col items-start justify-center ">
          ...
          <Box className="w-full flex flex-col items-start gap-y-3 justify-center ">
            <li className="text-[20px]">Core Fitness</li>
            <li className="text-[20px]">Muscle Fitness</li>
            <li className="text-[20px]">Yoga</li>
            <li className="text-[20px]">Kickboxing</li>
            <li className="text-[20px]">Gain Muscle</li>
          </Box>
        </Box>
      </Grid>
      <Grid container xs={12}>
        ...
        >
          <Grid
            container
            xs={12}
            className="relative bg-white h-auto p-5 sm:p-20 w-full  sm:mt-[0%]   flex items-center justify-center "
          >
            <Box
              onClick={handleClose}
              height={30}
            ...
            >
              <SwiperSlide className=" h-full flex my-auto  items-center justify-center ">
                <Image src={Lena1} height={500} width={700} alt="slider1" />
              </SwiperSlide>
              <SwiperSlide className=" h-full flex my-auto items-center justify-center ">
                <Image src={Lena2} height={500} width={700} alt="slider1" />
              </SwiperSlide>
              <SwiperSlide className=" h-full flex my-auto items-center justify-center ">
                <Image src={Lena3} height={500} width={700} alt="slider1" />
              </SwiperSlide>
              <SwiperSlide className=" h-full flex my-auto items-center justify-center ">
                <Image src={Lena1} height={500} width={700} alt="slider1" />
              </SwiperSlide>
