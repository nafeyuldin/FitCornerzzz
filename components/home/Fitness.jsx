...
import FitnessImg from '../../public/Assets/Home/pngegg-11 1.svg';
import Link from 'next/link';
import ArrowForwardIcon from '@mui/icons-material/ArrowForward';

const Fitness = () => {
  return (
    <div className="drink py-5 sm:py-16">
      <Grid container xs={10}>
        <Box className="w-1/2 pl-5 md:pl-20 flex flex-col left-[5%] right-[5%]  top-[20%] items-start justify-center">
          <Box className="flex gap-x-3   w-[100%]">
        ...
        <Box className="w-1/2 flex items-center justify-center px-5">
          <Image src={FitnessImg} height={484} alt="drink" />
        </Box>
      </Grid>
    </div>
  );
