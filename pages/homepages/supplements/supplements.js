...
const supplements = ({ img, title, link }) => {
  return (
      ...
      <Grid container md={9} className="mx-auto px-5 md:px-0 pb-10 sm:pb-20">
        <Grid xs={12} className="py-8 ">
          <Breadcrumbs aria-label="breadcrumb">
            ...
            <Typography color="text.primary">Proteins</Typography>
          </Breadcrumbs>
        </Grid>
        <Grid xs={12}>
          ...
          <Typography className="sm:text-[6vw] text-[35px] font-bold ">
            Supplements
          </Typography>
        </Grid>
        ...
        <Grid xs={12} className="pt-5 pb-16">
          <Grid className="">
            <Grid className=" md:flex flex-col gap-5  md:gap-y-0">
              <Grid className=" md:flex  gap-5">
                <Box className="flex mb-5 md:mb-0 gap-5">
                  <Card
                    img={Image1}
                    title="Sports Nutritionist"
                    link="/homepages/supplements/proteins"
                  />
                  <Card
                    img={Image1}
                ...
                <Box className="flex mb-5 md:mb-0 gap-5 items-center justify-center">
                  <Card
                    img={Image1}
                    title="Pregnant Diet Specialist"
                    className="xs:w-1/2 h-full"
                    link="/homepages/supplements/proteins"
                  />
                </Box>
              </Grid>
