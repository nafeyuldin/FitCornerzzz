...
import ProfileCard from '../../../components/PHNlena/Profilecard';
      ...
      <Grid container md={10} className="mx-auto px-5 md:px-0 pb-10 sm:pb-20">
        <Grid xs={12} className="py-8  ">
          <Breadcrumbs aria-label="breadcrumb">
            ...
            <Link
              underline="hover"
              color="inherit"
              href="/homepages/nutritionist/publichealthnutritionist"
            >
        ...
        <Grid xs={12}>
          <ProfileCard
            ...
            email="lenaperiazkinas@gmail.com"
            phone="+962798907906"
