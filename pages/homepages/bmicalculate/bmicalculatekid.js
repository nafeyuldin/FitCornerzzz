          ...
          <Box className="w-full">
            ...
            <Grid container xs={12}>
              <Grid
                item
                xs={1}
                className="bg-[#F2994A] md:py-7 py-5 flex items-center justify-end"
              >
              ...
              >
                <Typography className="md:mr-[-10px] mr-[-5px] md:text-[16px] text-[10px] z-50 text-white font-bold"></Typography>
              </Grid>
...
export default bmicalculatekid;
